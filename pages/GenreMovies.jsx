...
const GenreMovies = () => {
  ...
  return (
    <main className="min-h-screen p-6">
      <div className="px-4 sm:px-8 md:px-8 lg:px-16 pt-6 mb-6">
        <BackButton />
      </div>
      <div className="flex items-start justify-between flex-wrap gap-4 mb-6 px-4 sm:px-8 md:px-8 lg:px-16 pt-6">
